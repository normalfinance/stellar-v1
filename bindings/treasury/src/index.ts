...
export interface Client {
   ...
   */
  add_pair: ({admin, pair}: {admin: string, pair: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  set_risk_parameters: ({admin, pair, parameters}: {admin: string, pair: string, parameters: TreasuryRiskParameters}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  kill_withdraw_floor: ({admin}: {admin: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  unkill_withdraw_floor: ({admin}: {admin: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  static async deploy<T = Client>(
        ...
        {admin, emergency_admin, rewards_admin, operations_admin, pause_admin, emergency_pause_admins, system_fee_admin, usdc_oracle}: {admin: string, emergency_admin: string, rewards_admin: string, operations_admin: string, pause_admin: string, emergency_pause_admins: Array<string>, system_fee_admin: string, usdc_oracle: string},
    ...
    return ContractClient.deploy({admin, emergency_admin, rewards_admin, operations_admin, pause_admin, emergency_pause_admins, system_fee_admin, usdc_oracle}, options)
  }
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        ...
        "",
