...
export interface Client {
   ...
   */
  update: ({pool, pool_type, init_args, reserves}: {pool: string, pool_type: string, init_args: Array<u128>, reserves: Array<u128>}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAKaW5pdF9hZG1pbgAAAAAAAQAAAAAAAAAHYWNjb3VudAAAAAATAAAAAA==",
        ...
        "AAAAAQAAAAAAAAAAAAAACVBvb2xQbGFuZQAAAAAAAAMAAAAAAAAACWluaXRfYXJncwAAAAAAA+oAAAAKAAAAAAAAAAlwb29sX3R5cGUAAAAAAAARAAAAAAAAAAhyZXNlcnZlcwAAA+oAAAAK",
