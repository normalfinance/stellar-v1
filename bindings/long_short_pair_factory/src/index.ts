...
export interface Client {
   ...
   */
  mint: ({user, asset, collateral_token, tokens_to_mint}: {user: string, asset: string, collateral_token: string, tokens_to_mint: u128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  redeem: ({user, asset, collateral_token, tokens_to_redeem}: {user: string, asset: string, collateral_token: string, tokens_to_redeem: u128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  redeem_one: ({user, asset, collateral_token, side, tokens_to_redeem}: {user: string, asset: string, collateral_token: string, side: Side, tokens_to_redeem: u128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAQAAAAAAAAAAAAAADUZhY3RvcnlDb25maWcAAAAAAAABAAAAAAAAABJwYWlyX2NvbnRyYWN0X3dhc20AAAAAA+4AAAAg",
        ...
        "AAAAAAAAAAAAAAAEbWludAAAAAQAAAAAAAAABHVzZXIAAAATAAAAAAAAAAVhc3NldAAAAAAAABEAAAAAAAAAEGNvbGxhdGVyYWxfdG9rZW4AAAATAAAAAAAAAA50b2tlbnNfdG9fbWludAAAAAAACgAAAAEAAAAK",
        "AAAAAAAAAAAAAAAGcmVkZWVtAAAAAAAEAAAAAAAAAAR1c2VyAAAAEwAAAAAAAAAFYXNzZXQAAAAAAAARAAAAAAAAABBjb2xsYXRlcmFsX3Rva2VuAAAAEwAAAAAAAAAQdG9rZW5zX3RvX3JlZGVlbQAAAAoAAAABAAAACg==",
        "AAAAAAAAAAAAAAAKcmVkZWVtX29uZQAAAAAABQAAAAAAAAAEdXNlcgAAABMAAAAAAAAABWFzc2V0AAAAAAAAEQAAAAAAAAAQY29sbGF0ZXJhbF90b2tlbgAAABMAAAAAAAAABHNpZGUAAAfQAAAABFNpZGUAAAAAAAAAEHRva2Vuc190b19yZWRlZW0AAAAKAAAAAQAAAAo=",
