...
export type DataKey = {tag: "TokenLong", values: void} | {tag: "TokenShort", values: void} | {tag: "TokenCollateral", values: void} | {tag: "CollateralPerPair", values: void} | {tag: "ExpiryPercentLong", values: void} | {tag: "Calculator", values: void} | {tag: "Oracle", values: void} | {tag: "OracleGuardRails", values: void} | {tag: "HistoricalOracleData", values: readonly [string]} | {tag: "IsKilledCreate", values: void} | {tag: "IsKilledRedeem", values: void} | {tag: "IsKilledSettle", values: void};
...
export interface Client {
   ...
   */
  initialize: ({admin, privileged_addrs, tokens, oracle, calculator}: {admin: string, privileged_addrs: readonly [string, string, string, string, Array<string>, string], tokens: Array<string>, oracle: string, calculator: string}, options?: {
    /**
   ...
   *      * @return collateralReturned total collateral returned in exchange for the pair of synthetics.
   */
  settle: ({user, long_tokens_to_redeem, short_tokens_to_redeem}: {user: string, long_tokens_to_redeem: u128, short_tokens_to_redeem: u128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
  ...
  /**
   * Construct and simulate a get_expiration_price transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  get_expiration_price: ({user}: {user: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
  ...
  /**
   * Construct and simulate a kill_settle transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  kill_settle: ({admin}: {admin: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
  ...
  /**
   * Construct and simulate a unkill_settle transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  unkill_settle: ({admin}: {admin: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
  ...
  /**
   * Construct and simulate a get_is_killed_settle transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  get_is_killed_settle: (options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAKaW5pdGlhbGl6ZQAAAAAABQAAAAAAAAAFYWRtaW4AAAAAAAATAAAAAAAAABBwcml2aWxlZ2VkX2FkZHJzAAAD7QAAAAYAAAATAAAAEwAAABMAAAATAAAD6gAAABMAAAATAAAAAAAAAAZ0b2tlbnMAAAAAA+oAAAATAAAAAAAAAAZvcmFjbGUAAAAAABMAAAAAAAAACmNhbGN1bGF0b3IAAAAAABMAAAAA",
        ...
        "",
        "AAAAAAAAAAAAAAAKZ2V0X3Rva2VucwAAAAAAAAAAAAEAAAPqAAAAEw==",
        "AAAAAAAAAAAAAAAUZ2V0X2V4cGlyYXRpb25fcHJpY2UAAAABAAAAAAAAAAR1c2VyAAAAEwAAAAEAAAAK",
        ...
        "AAAAAAAAAAAAAAALa2lsbF9zZXR0bGUAAAAAAQAAAAAAAAAFYWRtaW4AAAAAAAATAAAAAA==",
        ...
        "AAAAAAAAAAAAAAANdW5raWxsX3NldHRsZQAAAAAAAAEAAAAAAAAABWFkbWluAAAAAAAAEwAAAAA=",
        "AAAAAAAAAAAAAAAUZ2V0X2lzX2tpbGxlZF9jcmVhdGUAAAAAAAAAAQAAAAE=",
        "AAAAAAAAAAAAAAAUZ2V0X2lzX2tpbGxlZF9yZWRlZW0AAAAAAAAAAQAAAAE=",
        "AAAAAAAAAAAAAAAUZ2V0X2lzX2tpbGxlZF9zZXR0bGUAAAAAAAAAAQAAAAE=",
        ...
        "AAAABAAAAAAAAAAAAAAAEkxvbmdTaG9ydFBhaXJFcnJvcgAAAAAAAwAAAAAAAAASQWxyZWFkeUluaXRpYWxpemVkAAAAAADJAAAAAAAAABFXcm9uZ0lucHV0VmVjU2l6ZQAAAAAAAMoAAAAAAAAADUludmFsaWRPcmFjbGUAAAAAAADL",
        ...
        "",
  ...
  public readonly fromJSON = {
    initialize: this.txFromJSON<null>,
        ...
        settle: this.txFromJSON<u128>,
        get_tokens: this.txFromJSON<Array<string>>,
        get_expiration_price: this.txFromJSON<u128>,
