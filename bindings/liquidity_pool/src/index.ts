...
export type DataKey = {tag: "TokenA", values: void} | {tag: "TokenB", values: void} | {tag: "ReserveA", values: void} | {tag: "ReserveB", values: void} | {tag: "FeeFraction", values: void} | {tag: "Plane", values: void} | {tag: "Router", values: void} | {tag: "IsKilledSwap", values: void} | {tag: "IsKilledDeposit", values: void} | {tag: "IsKilledClaim", values: void} | {tag: "TokenFutureWASM", values: void} | {tag: "GaugeFutureWASM", values: void} | {tag: "ProtocolFeeFraction", values: void} | {tag: "ProtocolFeeA", values: void} | {tag: "ProtocolFeeB", values: void};
...
export interface Client {
   ...
   */
  initialize_all: ({admin, privileged_addrs, router, lp_token_wasm_hash, tokens, fees_config, reward_token, plane, config_storage}: {admin: string, privileged_addrs: readonly [string, string, string, string, Array<string>, string], router: string, lp_token_wasm_hash: Buffer, tokens: Array<string>, fees_config: readonly [u32, u32], reward_token: string, plane: string, config_storage: string}, options?: {
    /**
   ...
   */
  initialize: ({admin, privileged_addrs, router, lp_token_wasm_hash, tokens, fees_config}: {admin: string, privileged_addrs: readonly [string, string, string, string, Array<string>, string], router: string, lp_token_wasm_hash: Buffer, tokens: Array<string>, fees_config: readonly [u32, u32]}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        ...
        "",
