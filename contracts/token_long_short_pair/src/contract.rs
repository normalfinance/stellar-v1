...
#[contract]
pub struct TokenLongShortPair;

#[contractimpl]
impl TokenLongShortPair {
...
#[contractimpl]
impl token::Interface for TokenLongShortPair {
    ...
    fn transfer(e: Env, from: Address, to: Address, amount: i128) {
        ...
        checkpoint_user_funding(&e, from.clone(), to.clone(), amount);
...
#[contractimpl]
impl UpgradeableContract for TokenLongShortPair {
    ...
    fn contract_name(e: Env) -> Symbol {
        Symbol::new(&e, "TokenLongShortPair")
    }
...
#[contractimpl]
impl TransferableContract for TokenLongShortPair {
